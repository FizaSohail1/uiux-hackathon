...
//       <div className="my-16 lg:my-32  mx-auto lg:mx-[170px] 2xl:mx-default-margin block space-y-3 lg:flex lg:items-center lg:justify-between">
//         <div className="">
...
//                <Link href={`/products/id?name=${product.name}&description=${product.discountPrice}&image=${product.image}&price=${product.price}`}>
