...
//       <div className="bg-white mx-auto md:mx-10 lg:mx-[170px] 2xl:mx-default-margin shadow-lg my-16 lg:my-32  px-3 py-2">
//         <div className='flex flex-col lg:flex-row mx-auto items-center '>
//             <div className=" space-y-3  hidden md:block ">
//                 <div className="border-[1px] h-[100px] w-[100px] rounded-[3px] 2xl:h-[155px] 2xl:w-[151px] items-center"> 
...
//             </div>
//             <p className='flex gap-2 text-headingsText text-[16px] leading-[29px] my-2'>${product.price} <span className='text-secondary line-through'>${product.discountprice}</span></p>
//             <h3 className='text-headingsText text-[16px] leading-[18.75px] my-2'>Color</h3>

//             <p className='text-[16px] leading-[25px] text-[#A9ACC6] max-w-[549px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris tellus porttitor purus, et volutpat sit.</p>

//             <Link href={'/cart'}>
//             <button className='text-headingsText text-[16px] leading-[29px] flex ml-7 gap-2 items-center rounded-lg flex cursor-pointer items-center p-3 w-[30%] bg-green-400 '>Add To cart <span>< FiHeart /></span></button>
//             </Link>
...
async function singleProductPage({searchParams} : {searchParams: Promise<{
  ...
  const {name,price,description,imagePath,category,discountPercentage} = await searchParams 
