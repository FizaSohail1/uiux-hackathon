          ...
          <div className="flex flex-col lg:flex-row lg:justify-between lg:gap-[30px]">
            <div className="">
              ...
              <div className="flex justify-between items-center mx-auto">
                <h2 className="text-lg lg:text-[20px] lg:leading-[23.44px] text-[#1D317B] lg:mx-8">
                  Product
                </h2>
                <h2 className="text-lg lg:text-[20px] lg:leading-[23.44px] text-[#1D317B] lg:mx-14">
                       Price
                    </h2>

                    <h2 className="text-lg lg:text-[20px] lg:leading-[23.44px] text-[#1D317B]">
                       Quantity
                    </h2>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <div className="">
                      <h3 className="text-sm text-black">Vel faucibus posuere</h3>
                      <p className="flex text-xs text-[#A1A8C1]">
                        color:<span className="text-sm">Brown</span>
                      </p>
                      <p className="flex text-xs text-[#A1A8C1]">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <div className="">
                      <h3 className="text-sm text-black">Ac vitae vestibulum</h3>
                      <p className="flex text-xs text-[#A1A8C1]">
                        color:<span className="text-sm">Brown</span>
                      </p>
                      <p className="flex text-xs text-[#A1A8C1]">
...
<button className="flex items-center justify-center w-4 h-full text-base text-gray-700">
  <FaPlus />
            ...
            <div>
              ...
              <div className="h-[264px] w-[371px] mx-auto md:mx-0 p-4 bg-maingray">
                <div className="flex items-center justify-between">
                    <h4 className="font-semibold text-lg text-[#15245E]">Subtotals:</h4>
                    <h4 className="font-semibold text-base text-[#15245E]">£219.00</h4>   
                </div>
                <hr className="border-1px border-solid border-[#E1E1E4] shadow-sm mt-2"/>
                <div className="flex items-center justify-between mt-4">
                    <h4 className="font-semibold text-lg text-[#15245E]">Totals:</h4>
                    <h4 className="font-semibold text-base text-[#15245E]">£219.00</h4>   
                </div>
                <hr className="border-1px border-solid border-[#E1E1E4] shadow-sm mt-2"/>

                <p className="font-normal text-xs flex gap-2 my-3"><span><FaCircle className="text-[#19d16f]"/></span> Shipping & taxes calculated at checkout</p>

                <button className="w-full h-[40px] text-center font-bold text-sm bg-[#19d16f] py-2 my-3 text-white">Proceed To Checkout</button>
              ...
              <div className="h-[264px] w-[371px] mx-auto md:mx-0 p-4 bg-maingray space-y-3">
                <div className="">
                ...
                <div className="">
                    <h4 className=" text-sm text-[#c5cbe3] mb-2">Mirpur Dhaka - 1200</h4>
                </div>
                <hr className="border-1px border-solid border-[#E1E1E4] shadow-sm mt-2 "/>
                <div className="">
                ...
                <hr className="border-1px border-solid border-[#E1E1E4] shadow-sm mt-2"/>
                <button className="w-1/2 h-[41px] text-center font-bold text-base bg-secondary py-2 my-3 text-white">Calculate Shiping</button>
           ...
           {/* <div className="flex justify-between">
                <button className="w-1/4 h-[41px] text-center font-bold text-base bg-secondary py-2">Update Curt</button>
                <button className="w-1/4 h-[41px] text-center font-bold text-base bg-secondary py-2">Clear Curt</button>
           </div> */}
          </div>
        </div>
      </div>
