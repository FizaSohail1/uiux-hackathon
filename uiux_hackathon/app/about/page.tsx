  ...
  return (
    <div>
        ...
        <div className="flex flex-col lg:flex-row justify-center gap-10 2xl:gap-14">
          <div className="bg-[#2b3cab] h-[320px] w-[280px] lg:h-[370px] lg:w-[552px] 2xl:h-[409px] 2xl:w-[552px] rounded-md mx-auto lg:mx-0">
            <Image
              ...
              height={390}
              width={555}
              className="object-cover h-[300px] w-[270px] lg:h-[350px] lg:w-[500px] 2xl:h-[390px] 2xl:w-[555px] rounded-md lg:ml-[15px]"
            />
          </div>

          <div className="">
            <h1 className="text-[36px] leading-[48px] font-bold w-full lg:w-[90%] mx-5 lg:mx-0">
              Know About Our Ecomerce Business, History
            </h1>
            <p className="text-[#8a8fb9] font-semibold my-5 w-full lg:w-[550px] mx-5 lg:mx-0">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus
              enim et minus doloribus ducimus voluptas, incidunt eveniet
              aliquid. Necessitatibus corrupti blanditiis rem amet rerum iure
              saepe, adipisci fugiat mollitia dolores.
            </p>
      ...
      <div className="bg-[#fbfbff] w-full h-auto lg:h-[400px] 2xl:h-[503px] flex items-center justify-center mx-auto my-10 md:my-20  border-b-[1px] border-b-yellow-600">
        <div className="">
          <h1 className="text-center font-bold text-3xl lg:text-[42px] lg:leading-[25.6px]">
            Our Client Say!
          </h1>
          ...
          <div className="">
            <h3 className="text-[22px] leading-[25.6px] text-center font-semibold">
              Selina Gomez
            </h3>
            ...
            <p className="my-6 text-[#8a8fb9] mx-auto flex justify-center font-bold text-[16px] leading-[25.4px] text-center lg:max-w-[689px]">
